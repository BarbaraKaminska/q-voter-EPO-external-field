...
plot!(p1, p, cE, seriestype=:scatter, markershape = :utriangle, framestyle=:box, xlabelfontsize=14, ylabelfontsize=14,
    label = "he = $(@sprintf("%.2f", he)); hp = $(@sprintf("%.2f", hp))")
plot!(p2, p, cP, seriestype=:scatter, markershape = :utriangle, framestyle=:box, xlabelfontsize=14, ylabelfontsize=14, label = false)
plot!(p3, p, diss, seriestype=:scatter, markershape = :utriangle, framestyle=:box, xlabelfontsize=14, ylabelfontsize=14, label = false)
